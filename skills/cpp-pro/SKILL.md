---
name: cpp-pro
description: Advanced C++17/20/23 engineering guidance based on the C++ Core Guidelines. Use when writing, reviewing, or refactoring C++ code that needs modern resource safety, type safety, templates, concurrency, standard library usage, or architectural cleanup.
---
